        ...
        <div className="agent-panel">
          ...
          <div className="agent-visual">
            <div className="agent-command-stage">
              ...
              <div className="agent-orbit orbit-main" />
              <div className="agent-orbit orbit-secondary" />

              <div className="agent-ui-card">

                <div className="agent-ui-header">
                  <div className="agent-ui-profile">
                    <span className="agent-ui-avatar">R</span>
                    <div>
                      <strong>ROBANK AI</strong>
                      <small><i /> Online</small>
                    </div>
                  </div>
                  <span className="agent-ui-more">•••</span>
                </div>

                <div className="agent-ui-message agent-ui-user">
                  Send $20 to Alice
                </div>

                <div className="agent-ui-message agent-ui-ai">
                  <div className="agent-ai-title">
                    <span className="agent-ai-pulse" />
                    Ready to execute
                  </div>

                  <strong>I'll send $20.00 USDC to Alice.</strong>
                  <p>Here's the transaction summary.</p>
                  ...
                  <button className="agent-confirm">
                    Confirm and send <span>↗</span>
                  </button>
                </div>

                <div className="agent-ui-input">
              ...
              <div className="agent-context-chip">
                <small>CONTEXT</small>
                <strong>Wallet · Payments · Transfers</strong>
              </div>
