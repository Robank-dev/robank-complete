...
export default function MarketsPage(){
 ...
 return <AppShell><div className="space-y-6"><div><div className="text-xs uppercase tracking-[.2em] text-white/40">MARKETS</div><h1 className="mt-2 text-3xl font-semibold">Market intelligence.</h1><p className="mt-2 text-sm text-white/50">Stocks, crypto and discoverable RWA assets in one surface. Prices are provider data, not simulated values.</p></div>{error&&<div className="rounded-xl border border-ro-line p-4 text-sm text-white/55">Live market data is unavailable. Connect the ROBANK market provider to enable stock and crypto prices.</div>}
