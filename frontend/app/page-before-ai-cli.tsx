      ...
      <section id="agent" className="section agent-section">
        <div className="agent-panel">
          ...
          <div className="agent-visual">
            <div className="agent-simulation-stage">

              <div className="agent-sim-orbit sim-orbit-a" />
              <div className="agent-sim-orbit sim-orbit-b" />

              <div className="agent-sim-card">

                <div className="agent-sim-header">
                  <div className="agent-sim-profile">
                    <span className="agent-sim-avatar">R</span>
                    <div>
                      <strong>ROBANK AI</strong>
                      <small><i /> Online</small>
                    </div>
                  </div>
                  <span className="agent-sim-menu">•••</span>
                </div>

                <div className="agent-sim-feed">

                  <div className="sim-step sim-user-message">
                    <span className="sim-message-label">YOU</span>
                    <div className="sim-user-bubble">
                      Send $20 to Alice
                    </div>
                  </div>

                  <div className="sim-step sim-thinking">
                    <span className="sim-ai-dot" />
                    <span>ROBANK is thinking</span>
                    <b><i /><i /><i /></b>
                  </div>

                  <div className="sim-step sim-ai-message">
                    <div className="sim-ai-heading">
                      <span className="sim-ai-icon">R</span>
                      <span>ROBANK AI</span>
                    </div>
                    <strong>Got it. I'll prepare the payment.</strong>
                    <small>Checking recipient and available balance...</small>
                  </div>

                  <div className="sim-step sim-transaction">
                    <div className="sim-tx-top">
                      <span>TRANSACTION PREVIEW</span>
                      <b>READY</b>
                    </div>

                    <div className="sim-tx-main">
                      <span className="sim-send-icon">↗</span>
                      <div>
                        <small>SEND</small>
                    ...
                    <div className="sim-action">
                      <span className="sim-action-confirm">Confirm &amp; send <b>↗</b></span>
                      <span className="sim-action-processing"><i /> Processing...</span>
                      <span className="sim-action-sent">✓ Payment sent</span>
                    </div>
                  </div>

                  <div className="sim-step sim-success">
              ...
              <div className="agent-sim-status">
                <span className="sim-live-dot" />
                <div>
                  <small>LIVE SIMULATION</small>
                  <strong>Agent ready to act</strong>
                </div>
              </div>

              <div className="agent-sim-context">
                <small>AUTONOMOUS FLOW</small>
                <strong>Request → Review → Execute</strong>
              </div>
